package com.wzsykj.bopihui.ui.good;
...
import com.wzsykj.bopihui.Bean.Good;
import com.wzsykj.bopihui.R;
import com.wzsykj.bopihui.adapter.GoodsListRecyclerAdapter;
import com.wzsykj.bopihui.adapter.PopListAdapter;
import com.wzsykj.bopihui.base.BaseActivity;
import com.wzsykj.bopihui.network.AppHttp;
import com.wzsykj.bopihui.utils.BracastUtil;
import com.wzsykj.bopihui.utils.DensityUtil;
import com.wzsykj.bopihui.utils.MyCallBack;
import com.wzsykj.bopihui.utils.SharePerfenceUtils;
import com.wzsykj.bopihui.utils.StringUtils;
import com.wzsykj.bopihui.utils.ToastUtils;
import com.wzsykj.bopihui.utils.XUtils;
import com.wzsykj.bopihui.widget.BadgeView;
import com.wzsykj.bopihui.widget.GridDividerItemDecoration;
...
public class GoodListActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Button sureBtn, resetBtn;    //确定按钮
...
//                laodData();
    ...
    private void showPopwindows() {
        if (popupWindow == null) {
            ...
            XUtils.Get(AppHttp.BASE_URL + "index.php?ctl=goods&order_type=" + loadType + "&" + Findtype + "=" + cate_id + "&f=" + shaixunStr + "&page=1&shop_id="+new SharePerfenceUtils(this).getShop_id()[0]+"", null, new MyCallBack<String>() {
                @Override
    ...
    public void FindGoodsByType(String type, String f) {
        materialishProgress.show();
        priceList.clear();
        data.clear();
        imageList.clear();
        goodsIdList.clear();
        XUtils.Get(AppHttp.BASE_URL + "index.php?ctl=goods&" + Findtype + "=" + type + "&f=" + f + "&shop_id="+new SharePerfenceUtils(this).getShop_id()[0]+"", null, new MyCallBack<String>() {
            @Override
            public void onSuccess(String result) {
                try {
                    JSONObject jsonObject = new JSONObject(StringUtils.base64ToString(result));
    ...
    public void LoadMoreData(final String fenlei,final String type, final String f, final int page) {
        //XUtils.Get(AppHttp.BASE_URL + "index.php?ctl=goods&order_type=" + type + "&" + Findtype + "=" + id + "&f=" + shaixunStr + "&page=1&shop_id="+new SharePerfenceUtils(this).getShop_id()[0]+"", null, new MyCallBack<String>() {
        XUtils.Get(AppHttp.BASE_URL + "index.php?ctl=goods&order_type="+fenlei+"&" + Findtype + "=" + type + "&f=" + f + "&page="+page+"&shop_id="+new SharePerfenceUtils(this).getShop_id()[0]+"", null, new MyCallBack<String>() {
            @Override
            public void onSuccess(String result) {
                try {
                     System.out.println(AppHttp.BASE_URL + "index.php?ctl=goods&order_type="+fenlei+"&" + Findtype + "=" + type + "&f=" + f + "&page="+page+"&shop_id="+new SharePerfenceUtils(GoodListActivity.this).getShop_id()[0]+"");
                    JSONObject jsonObject = new JSONObject(StringUtils.base64ToString(result));
                    JSONArray goodsList = jsonObject.getJSONArray("item");
